                            ...
                            <tbody>
                                @foreach ($list_article as $article)
                                    <tr>
                                       ...
                                       <td>
                                            <div class="btn-group">
                                            <a href="{{url('admin/article', $article->id)}}" class="btn btn-dark" ><i  class="fa fa-info" data-feather="info"></i></a>
                                            <a href="{{url('admin/article', $article->id)}}/edit" class="btn btn-warning"><i class="fa fa-edit"data-feather="edit" ></i></a>
